...
(input_date) => { 
                    ...
                    let selected_day_of_week = input_date.getDay();
                    //console.log('Print from get_date_of_nearest_monday:', input_date.getFullYear());
                    //console.log('Print from get_date_of_nearest_monday:', input_date.getMonth()+1);
                    //console.log('Print from get_date_of_nearest_monday:', input_date.getDate());
                    if (selected_day_of_week === 0)
                    {
